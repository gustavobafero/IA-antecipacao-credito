...
def exibir_interface_analise_risco():
    ...
    with st.form("form_operacao"):
        ...
        margem_desejada = st.number_input("Margem desejada (%)", min_value=0.0, value="Digite Aqui")
        custo_capital   = st.number_input("Custo do capital (%)", min_value=0.0, value="Digite Aqui")
